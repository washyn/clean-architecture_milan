...
//     {
//         // var role = await this..FindByNormalizedUserNameAsync(this.LookupNormalizer.NormalizeName(user.UserName));
//         // if (role is null)
//         // {
//         //     var newRole = new Volo.Abp.Identity.IdentityUser(GuidGenerator.Create(), user.UserName, user.Email, null);
//         //     await IdentityUserManager.CreateAsync(newRole);
//         // }
